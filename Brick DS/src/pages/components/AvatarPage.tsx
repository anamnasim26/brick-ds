    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-16 pt-24 pb-20 sm:px-32 sm:pt-32 sm:pb-24 md:px-48 md:pt-40 md:pb-32 border-b border-brick-grey-300 bg-brick-grey-white flex flex-wrap items-start justify-between gap-16 md:gap-24">
        <div>
          ...
          <h1 className="text-32 font-bold text-brick-grey-950 mb-4">Avatar</h1>
          <p className="text-16 text-brick-grey-600 leading-24">
            Shows a person or entity. Comes in three modes — image, initials, or icon — across four sizes, with an optional status dot.
          </p>
        </div>
      </div>

      <ComponentTabs storybookUrl="https://brick-ds-storybook.vercel.app/?path=/docs/components-avatar--docs" usage={usageContent} changelog={changelog} playground={<div className="flex flex-col-reverse md:flex-row flex-1 min-h-0">
        {/* Controls */}
