    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-16 pt-24 pb-20 sm:px-32 sm:pt-32 sm:pb-24 md:px-48 md:pt-40 md:pb-32 border-b border-brick-grey-300 bg-brick-grey-white flex flex-wrap items-start justify-between gap-16 md:gap-24">
        <div>
          ...
          <h1 className="text-32 sm:text-40 md:text-48 font-bold text-brick-grey-950 leading-tight mb-8 md:mb-12">avatar</h1>
        ...
        <a
          href="https://brick-ds-storybook.vercel.app/?path=/docs/components-avatar--docs"
          target="_blank"
